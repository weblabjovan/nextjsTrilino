    			...
    			<div className="helpPage">
    				...
    				<div className="section" id="activationSec">
    					...
    					<ul>
                            ...
                            <li>U sekciji <strong>OSNOVNO</strong> potrebno je popuniti svako polje u delovima: <strong>PROSTOR</strong>, <strong>RADNO VREME</strong>, <strong>KARAKTERISTIKE</strong>, <strong>TERMINI/SALE</strong>. Takođe, potrebno je uneti minimalno 4 termina po sali kako bi sekcija <strong>KALENDAR</strong> bila opearativna.</li>
    						<li>Nakon sekcije <strong>OSNOVNO</strong> potrebno je popuniti sekciju <strong>HRANA I PIĆE</strong> u kojoj u koliko nudite ketering pakete morate ponuditi barem jedan paket. Takođe ukoliko nudite piće svojim gostima morate kreirati kartu pića od minimum 6 različitaih pića.</li>
    						<li>Nakon sekcije <strong>HRANA I PIĆE</strong> potrebno je popuniti sekciju <strong>PONUDA</strong> u kojoj je potrebno izabrati minimum 4 različita besplatna sadržaja koje nudite deci koja su gosti proslava u vašem prostoru.</li>
