          ...
          <Row>
            <Col xs="12">
              <div className="pageHeader">
                ...
                <p>{this.state.dictionary['partnerProfileCateringDescription']}<a href={`/partnerHelp/${this.props.lang}/?section=catering`} target="_blank">{this.state.dictionary['uniPartnerProfileHelp']}</a></p>
              </div>
            </Col>
