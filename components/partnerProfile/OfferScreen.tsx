          ...
          <Row>
            <Col xs="12">
              <div className="pageHeader">
                ...
                <p>{this.state.dictionary['partnerProfileOfferDescription']}<a href={`/partnerHelp?language=${this.props.lang}&section=content`} target="_blank">{this.state.dictionary['uniPartnerProfileHelp']}</a></p>
              </div>
            </Col>
